...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BINLIBDEST': '/data/data/com.termux/files/usr/lib/python3.10',
 ...
 'BLDSHARED': 'aarch64-linux-android-clang -shared '
              ...
              '-Wl,-z,relro,-z,now '
              '-Wl,--no-as-needed,-landroid-support,--as-needed '
              '-L/home/builder/.termux-build/_cache/android-r25b-api-24-v0/sysroot/usr/lib '
              '-L/data/data/com.termux/files/usr/lib '
              '-Wl,-rpath=/data/data/com.termux/files/usr/lib -fopenmp '
              '-static-openmp -Wl,--enable-new-dtags -Wl,--as-needed '
              '-Wl,-z,relro,-z,now '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           '-fwrapv -O3 -Wall -fstack-protector-strong -O3  '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-fstack-protector-strong -O3',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/data/data/com.termux/files/usr/include '
                       '-I/home/builder/.termux-build/_cache/android-r25b-api-24-v0/sysroot/usr/include',
 'CONFIGURE_LDFLAGS': '-L/data/data/com.termux/files/usr/lib '
                      '-Wl,-rpath=/data/data/com.termux/files/usr/lib -fopenmp '
                      '-static-openmp -Wl,--enable-new-dtags -Wl,--as-needed '
                      '-Wl,-z,relro,-z,now '
                      '-Wl,--no-as-needed,-landroid-support,--as-needed '
 ...
 'CONFIG_ARGS': "'--disable-dependency-tracking' "
                ...
                "'--host=aarch64-linux-android' 'ac_cv_file__dev_ptmx=yes' "
                "'ac_cv_file__dev_ptc=no' 'ac_cv_func_wcsftime=no' "
                "'ac_cv_func_ftime=no' 'ac_cv_func_faccessat=no' "
                "'--build=x86_64-pc-linux-gnu' '--with-system-ffi' "
                "'--with-system-expat' '--without-ensurepip' "
                "'ac_cv_func_linkat=no' 'ac_cv_buggy_getaddrinfo=no' "
                ...
                "'CC=aarch64-linux-android-clang' 'CFLAGS= "
                "-fstack-protector-strong -O3' "
                ...
                "'PKG_CONFIG=/home/builder/.termux-build/_cache/android-r25b-api-24-v0/bin/pkg-config' "
                "'PKG_CONFIG_LIBDIR=/data/data/com.termux/files/usr/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/data/data/com.termux/files/usr/include',
 'CONFINCLUDEPY': '/data/data/com.termux/files/usr/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/builder/.termux-build/python/build/coverage.info',
 'COVERAGE_REPORT': '/home/builder/.termux-build/python/build/lcov-report',
 ...
 'DESTDIRS': '/data/data/com.termux/files/usr '
             ...
             '/data/data/com.termux/files/usr/lib/python3.10/lib-dynload',
 'DESTLIB': '/data/data/com.termux/files/usr/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/data/data/com.termux/files/usr/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLUDEPY': '/data/data/com.termux/files/usr/include/python3.10',
 ...
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/data/data/com.termux/files/usr/lib/python3.10',
 'LIBDIR': '/data/data/com.termux/files/usr/lib',
 ...
 'LIBPL': '/data/data/com.termux/files/usr/lib/python3.10/config-3.10',
 ...
 'LIBS': '-lcrypt -ldl  -lm',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'aarch64-linux-android-clang',
 'LINKFORSHARED': '-pie -Xlinker -export-dynamic',
 'LIPO_32BIT_FLAGS': '',
 'LIPO_INTEL64_FLAGS': '',
 'LLVM_PROF_ERR': 'no',
 'LLVM_PROF_FILE': 'LLVM_PROFILE_FILE="code-%p.profclangr"',
 'LLVM_PROF_MERGER': '/home/builder/.termux-build/_cache/android-r25b-api-24-v0/bin/llvm-profdata '
                     'merge -output=code.profclangd *.profclangr',
 'LN': 'ln',
 'LOCALMODLIBS': '',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/data/data/com.termux/files/usr/lib/python3.10',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'aarch64-linux-android-clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': '/home/builder/.termux-build/python/src/Modules/makesetup',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/data/data/com.termux/files/usr/include',
 'OPENSSL_LDFLAGS': '-L/data/data/com.termux/files/usr/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/builder/.termux-build/python/build '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/builder/.termux-build/python/build/`cat '
                     'pybuilddir.txt`:)/home/builder/.termux-build/python/src/Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden  '
                             '-I/home/builder/.termux-build/python/src/Include/internal '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
              '-g -fwrapv -O3 -Wall -fstack-protector-strong -O3  '
              '-fstack-protector-strong -O3',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   '-DNDEBUG -g -fwrapv -O3 -Wall -fstack-protector-strong '
                   '-O3  -fstack-protector-strong -O3 -std=c99 -Wextra '
                   '-Wno-unused-result -Wno-unused-parameter '
                   ...
                   '-I/home/builder/.termux-build/_cache/android-r25b-api-24-v0/sysroot/usr/include '
                   '-fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/data/data/com.termux/files/usr/lib '
                    '-Wl,-rpath=/data/data/com.termux/files/usr/lib -fopenmp '
                    '-static-openmp -Wl,--enable-new-dtags -Wl,--as-needed '
                    '-Wl,-z,relro,-z,now '
                    '-Wl,--no-as-needed,-landroid-support,--as-needed '
 ...
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/data/data/com.termux/files/usr/lib '
               '-Wl,-rpath=/data/data/com.termux/files/usr/lib -fopenmp '
               '-static-openmp -Wl,--enable-new-dtags -Wl,--as-needed '
               '-Wl,-z,relro,-z,now '
               '-Wl,--no-as-needed,-landroid-support,--as-needed '
 ...
 'TCLTK_INCLUDES': '-I/data/data/com.termux/files/usr/include',
 'TCLTK_LIBS': '-L/data/data/com.termux/files/usr/lib -ltk8.6 -ltkstub8.6 '
               '-ltcl8.6 -ltclstub8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': './python '
               '/home/builder/.termux-build/python/src/Tools/scripts/run_tests.py',
 ...
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': '/home/builder/.termux-build/python/src/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 0,
 'VERSION': '3.10',
 'VPATH': '/home/builder/.termux-build/python/src',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/home/builder/.termux-build/python/build',
 'abs_srcdir': '/home/builder/.termux-build/python/src',
 'datarootdir': '/data/data/com.termux/files/usr/share',
 'exec_prefix': '/data/data/com.termux/files/usr',
 'prefix': '/data/data/com.termux/files/usr',
 'srcdir': '/home/builder/.termux-build/python/src'}
